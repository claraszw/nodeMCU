...
socketio = test.socketio

room514 = Blueprint('room514', __name__)
...
@room514.route('/514', methods=['GET', 'POST'])
def hello_world():
...
@room514.route('/514/new/',methods=['GET', 'POST'])
def new():
...
@room514.route('/deleteRule',methods=['GET', 'POST'])
def deleteRule():
